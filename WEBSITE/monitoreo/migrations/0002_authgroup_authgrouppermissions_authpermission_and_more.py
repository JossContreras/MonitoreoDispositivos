    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ip', models.CharField(blank=True, max_length=60, null=True, unique=True)),
            ],
            options={
                'db_table': 'inventario',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id_ubicacion', models.OneToOneField(db_column='id_ubicacion', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='monitoreo.ubicacion')),
            ],
            options={
